...
export const conferences = [
  ...
  },
  {
    ...
    region: "Avrupa",
    regionEn: "Europe",
    tagsEn: ["Political science", "Environmental policies"],
    date: "2026-09-07",
    deadline: "2026-07-01",
    lastUpdated: "2026-06-14",
    tags: ["Siyaset bilimi", "Çevre politikaları"],
    grants: true,
    details: {
      type: "custom",
      summary: {
  ...
  //ANTROPOLOJİ KONFERANSLARI
{
 ...
 
  {
    ...
    tagsEn: ["Cultural studies"],
    date: "2026-07-27",
    deadline: "2026-01-19",
    lastUpdated: "2026-06-14",
    tags: ["Kültürel çalışmalar"],
    grants: true,
    details: {
      type: "custom",
      summary: {
