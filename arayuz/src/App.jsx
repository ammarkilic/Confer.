              ...
              {sorted.map((conf, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`absolute inset-x-4 bg-white rounded-t-xl pt-[33px] pb-4 px-5 shadow-sm border border-stone-200/80 transition-all duration-300 ease-out z-10 flex flex-col justify-between ${
                      ...
                      <div className="absolute top-[29px] right-5 w-12 h-12 bg-white p-[3px] shadow-md border-2 border-dashed border-stone-400/80 transform rotate-3 select-none flex items-center justify-center shrink-0">
                        <img 
