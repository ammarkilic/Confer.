              ...
              {sorted.map((conf, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`absolute inset-x-4 ${conf.id === 'aps-2026' ? 'bg-[#faf9f3]' : 'bg-white'} rounded-t-xl pt-[33px] pb-4 px-5 shadow-sm border border-stone-200/80 transition-all duration-300 ease-out z-10 flex flex-col justify-between ${
